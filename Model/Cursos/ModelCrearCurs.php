...
class CrearCurs {
    ...
    public function crearCrus($nom_curs,$descripcio,$data_inici,$data_fi,$id_professor,$preu,$estat,$placesDisponibles){
        ...
        $sql=$this->conn->prepare("INSERT INTO curs (nom_curs,curs_descripcio,data_inici,data_fi,id_profesor,preu,estat,placesDisponibles) VALUES(?,?,?,?,?,?,?,?)");
        $sql->bind_param("ssssssss",$nom_curs,$descripcio,$data_inici,$data_fi,$id_professor,$preu,$estat,$placesDisponibles);
        $sql->execute();
