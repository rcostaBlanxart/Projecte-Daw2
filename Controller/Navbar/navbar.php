...
function mostrarNavbar() {
    ...
    $navbar.= '<li><hr class="dropdown-divider"></li><li><a class="dropdown-item" href="login.php">Iniciar Sessió</a></li>';
        }
        if(isset($_SESSION["usuari"])){
    $navbar .= '<li><hr class="dropdown-divider"></li><li><a class="dropdown-item" href="../../Controller/Login/destruir_session.php">Tancar Sessió</a></li></ul></div></nav>';
        }
    $navbar .= '</ul></div></nav>';
