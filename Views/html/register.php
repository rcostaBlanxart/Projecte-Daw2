    ...
    <main class="row">
        ...
        <section class="col-md-6 bg-light" id="panel-right">
            <div class="container">
                ...
                <div class="row">                    
                    <form action="../../Controller/Register/ControllerRegister.php" method="post" class="col-12 col-md-8 offset-md-2" id="myForm">
                        <div class="form-group">
                            <input type="text" class="form-control" name="username" id="username" placeholder="Nom d'usuari" ">
                        ...
                        <div class="form-group text-center pt-4">
                            <input type="submit" id="loginbtn2" class="btn" value="Registrar-se" >
                        </div>
                    </form>
                </div>
                <div class="row mt-5">
